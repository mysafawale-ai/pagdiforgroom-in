...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/premium-pagdi-with-kalgi-in-pagdi-groom",
    type: "website",
  },
}
...
export default function PremiumPagdiWithKalgiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Emergency last-minute service available in India"],
