...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/rajwadi-pagdi-in-pagdi-groom",
    type: "website",
  },
}
...
export default function RajwadiPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit"],
