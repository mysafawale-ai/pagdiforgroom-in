...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/wedding-safa-for-barati-in-pagdi-groom",
    type: "website",
  },
}
...
export default function WeddingSafaForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations"],
