...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/designer-wedding-turban-in-pagdi-groom",
    type: "website",
  },
}
...
export default function DesignerWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Expert turban specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders"],
