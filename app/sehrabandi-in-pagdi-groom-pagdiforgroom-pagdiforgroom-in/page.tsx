...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/sehrabandi-in-pagdi-groom",
    type: "website",
  },
}
...
export default function SehrabandiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Expert sehra specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations"],
