...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/custom-wedding-safa-in-pagdi-groom",
    type: "website",
  },
}
...
export default function CustomWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
