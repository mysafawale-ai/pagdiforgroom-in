...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/groom-feta-in-pagdi-groom",
    type: "website",
  },
}
...
export default function GroomFetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert feta specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp"],
