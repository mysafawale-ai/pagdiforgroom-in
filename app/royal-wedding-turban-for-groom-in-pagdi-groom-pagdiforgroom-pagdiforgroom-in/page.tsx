...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/royal-wedding-turban-for-groom-in-pagdi-groom",
    type: "website",
  },
}
...
export default function RoyalWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day"],
