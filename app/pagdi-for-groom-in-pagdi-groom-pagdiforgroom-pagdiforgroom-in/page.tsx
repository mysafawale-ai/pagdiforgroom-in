...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/pagdi-for-groom-in-pagdi-groom",
    type: "website",
  },
}
...
export default function PagdiForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
