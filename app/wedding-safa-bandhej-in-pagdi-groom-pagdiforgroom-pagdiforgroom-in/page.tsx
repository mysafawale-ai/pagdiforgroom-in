...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/wedding-safa-bandhej-in-pagdi-groom",
    type: "website",
  },
}
...
export default function WeddingSafaBandhejInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp"],
