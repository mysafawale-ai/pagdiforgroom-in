...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/wedding-safa-for-groom-in-pagdi-groom",
    type: "website",
  },
}
...
export default function WeddingSafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics"],
