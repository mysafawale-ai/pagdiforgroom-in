...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/traditional-indian-wedding-turban-for-groom-in-pagdi-groom",
    type: "website",
  },
}
...
export default function TraditionalIndianWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations"],
