...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/groom-pagri-in-pagdi-groom",
    type: "website",
  },
}
...
export default function GroomPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Expert pagri specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics"],
