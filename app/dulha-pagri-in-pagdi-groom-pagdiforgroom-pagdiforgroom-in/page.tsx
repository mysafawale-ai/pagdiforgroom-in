...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/dulha-pagri-in-pagdi-groom",
    type: "website",
  },
}
...
export default function DulhaPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Expert pagri specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations"],
