...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/hand-tied-safa-rental-near-me-in-pagdi-groom",
    type: "website",
  },
}
...
export default function HandTiedSafaRentalNearMeInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in India"],
