...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/dulhe-ki-pagdi-in-pagdi-groom",
    type: "website",
  },
}
...
export default function DulheKiPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],
