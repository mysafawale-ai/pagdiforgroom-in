...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/premium-wedding-safa-for-international-groom-in-pagdi-groom",
    type: "website",
  },
}
...
export default function PremiumWeddingSafaForInternationalGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders"],
