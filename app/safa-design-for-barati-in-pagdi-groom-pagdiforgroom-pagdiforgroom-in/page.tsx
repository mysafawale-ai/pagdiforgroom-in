...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/safa-design-for-barati-in-pagdi-groom",
    type: "website",
  },
}
...
export default function SafaDesignForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination"],
