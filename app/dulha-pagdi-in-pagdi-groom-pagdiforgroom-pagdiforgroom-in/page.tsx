...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/dulha-pagdi-in-pagdi-groom",
    type: "website",
  },
}
...
export default function DulhaPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue"],
