...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/marathi-pheta-in-pagdi-groom",
    type: "website",
  },
}
...
export default function MarathiPhetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue"],
