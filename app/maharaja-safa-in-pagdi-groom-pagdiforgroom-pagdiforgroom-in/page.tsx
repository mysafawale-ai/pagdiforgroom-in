...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/maharaja-safa-in-pagdi-groom",
    type: "website",
  },
}
...
export default function MaharajaSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day"],
