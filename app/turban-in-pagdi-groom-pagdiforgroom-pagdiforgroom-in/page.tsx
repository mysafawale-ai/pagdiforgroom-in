...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/turban-in-pagdi-groom",
    type: "website",
  },
}
...
export default function TurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders"],
