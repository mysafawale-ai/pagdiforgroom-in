...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/safa-on-rent-near-me-in-pagdi-groom",
    type: "website",
  },
}
...
export default function SafaOnRentNearMeInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders"],
