...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/rajasthani-wedding-safa-in-pagdi-groom",
    type: "website",
  },
}
...
export default function RajasthaniWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in India"],
