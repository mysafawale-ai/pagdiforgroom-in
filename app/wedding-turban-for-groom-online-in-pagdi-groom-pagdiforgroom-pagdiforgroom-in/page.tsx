...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/wedding-turban-for-groom-online-in-pagdi-groom",
    type: "website",
  },
}
...
export default function WeddingTurbanForGroomOnlineInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics"],
