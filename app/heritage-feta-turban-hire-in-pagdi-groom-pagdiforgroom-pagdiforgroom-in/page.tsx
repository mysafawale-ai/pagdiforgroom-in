...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/heritage-feta-turban-hire-in-pagdi-groom",
    type: "website",
  },
}
...
export default function HeritageFetaTurbanHireInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders"],
