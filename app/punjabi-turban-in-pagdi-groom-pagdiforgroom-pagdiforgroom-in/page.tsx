...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/punjabi-turban-in-pagdi-groom",
    type: "website",
  },
}
...
export default function PunjabiTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
