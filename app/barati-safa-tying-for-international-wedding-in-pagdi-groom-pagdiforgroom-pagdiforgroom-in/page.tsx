...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/barati-safa-tying-for-international-wedding-in-pagdi-groom",
    type: "website",
  },
}
...
export default function BaratiSafaTyingForInternationalWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders"],
