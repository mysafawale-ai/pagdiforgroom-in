...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.in/mens-wedding-turban-in-pagdi-groom",
    type: "website",
  },
}
...
export default function MensWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Expert turban specialists with 40+ years experience in India", "On-site professional service at your India venue", "Complete barati packages with matching coordination"],
